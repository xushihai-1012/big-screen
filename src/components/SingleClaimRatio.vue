<template>
  <div class="wrapper">
    ...
    <div class="singleclaimratio chartbox"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    getEchart () {
      this.myChart = this.$echarts.init(document.querySelector('.singleclaimratio'))
      const option = {
        tooltip: {
          trigger: 'axis',
          axisPointer: {
